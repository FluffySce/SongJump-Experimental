...
import { handleSpotifyCallback } from "./spotify.auth.service.js";
import * as spotifyDataService from "./spotify.data.service.js";
...
export const getPlaylists = async (req, res) => {
  try {
    const playlists = await spotifyDataService.getUserPlaylists(req.user.id);
